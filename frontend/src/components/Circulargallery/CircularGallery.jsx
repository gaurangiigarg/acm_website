...
const cardData = [
  ...
  },
  {
    color: '#000000',
    title: 'Technical',
    description: 'SPY-C is an initiative to build core programming foundations and help students overcome their fear of coding by perfecting their knowledge of DSA through guidance from experienced seniors.',
    label: 'SPY-C',
    image: Spyc
  },
  {
    ...
    title: null,
    description: null,
    label: 'Our techical initiatives are dedicated peer mentorship programs focused on mastering foundational coding languages through continuous guidance from seniors. It ensures practical skill transfer and supports consistent learning.',
    image: null
  },
  {
    color: '#000000',
    title: 'Technical',
    description: 'Peer Coding Mastery',
    label: '21 Days Of Code',
    image: DOC
  }
];
          ...
          if (enableStars) {
            return (
              ...
              >
                ...
                {/* UPDATED: Render Image if present */}
                {card.image && (
