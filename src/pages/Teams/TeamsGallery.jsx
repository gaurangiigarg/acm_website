...
// --- Data for the gallery cards with size variations ---
const galleryData = [
  {
  ...
  {
    imageUrl: 'https://raw.githubusercontent.com/upesnavneet/acm_assets/main/img/Prodigy24/HRK_0356.JPG',
    size: 'small'
  },
  {
    imageUrl: 'https://raw.githubusercontent.com/upesnavneet/acm_assets/main/img/Prodigy24/HRK_7147.JPG',
    size: 'large'
  },
  {
  ...
  {
    imageUrl: 'https://raw.githubusercontent.com/upesnavneet/acm_assets/main/img/sherlocked/img1.jpg',
    size: 'large'
  },
  {
    imageUrl: 'https://raw.githubusercontent.com/upesnavneet/acm_assets/main/img/HOC/img1.jpg',
    size: 'small'
  },
  {
    imageUrl: 'https://raw.githubusercontent.com/upesnavneet/acm_assets/main/img/HOC/img2.jpg',
    size: 'large'
  },
  {
    imageUrl: 'https://raw.githubusercontent.com/upesnavneet/acm_assets/main/img/sherlocked/img2.jpeg',
    size: 'small'
  }
];
        ...
        <div className="scrolling-track">
          {extendedGalleryData.map((item, index) => (
            <div className={`gallery-card ${item.size}`} key={index}>
              <img src={item.imageUrl} alt={`Team gallery item ${index + 1}`} />
            </div>
          ))}
        </div>
      </div>
